...
$router->addRoute('GET', '/contract/countries', 'App\Controllers\APIController::getCountriesContracts');
...
$router->addRoute('GET', '/contracts/metadata/download', 'App\Controllers\APIController::downloadMetadataAsCSV');
